...
{
    public class NewDatabaseServiceViewModel : BaseWorkSurfaceViewModel, IHelpSource, IStudioTab
    {
        string _helpText;
        IManageDbServiceViewModel _vm;
        readonly IPopupController _popupController;
        string _displayName;

        public NewDatabaseServiceViewModel(IEventAggregator eventPublisher, IManageDbServiceViewModel vm, IPopupController popupController)
            : base(eventPublisher)
        {
            ViewModel = vm;
        ...
        public override string DisplayName
        {
            get
            {
                return ViewModel.DataSourceHeader;
            }
            set
            {
                _displayName = value;
        ...
        public IManageDbServiceViewModel ViewModel
        {
            get
            {
                return _vm;
