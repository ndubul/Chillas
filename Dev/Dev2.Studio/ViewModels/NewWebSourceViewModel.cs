...
{
    public class NewWebSourceViewModel : BaseWorkSurfaceViewModel, IHelpSource, IStudioTab
    {
        string _helpText;
        IManageWebserviceSourceViewModel _vm;
        readonly IPopupController _popupController;
        string _displayName;

        public NewWebSourceViewModel(IEventAggregator eventPublisher, IManageWebserviceSourceViewModel vm, IPopupController popupController)
            : base(eventPublisher)
        {
            ViewModel = vm;
        ...
        {
            var view = new ManageWebserviceSourceControl();
            return view;
        }
        ...
        {
            var loadedView = view as ManageWebserviceSourceControl;
            if (loadedView != null)
            {
        ...
        public IManageWebserviceSourceViewModel ViewModel
        {
            get
            {
                return _vm;
