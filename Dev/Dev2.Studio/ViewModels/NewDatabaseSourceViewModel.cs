...
{
    public class NewDatabaseSourceViewModel : BaseWorkSurfaceViewModel, IHelpSource, IStudioTab
    {
        string _helpText;
        IManageDatabaseSourceViewModel _vm;
        readonly IPopupController _popupController;
        string _displayName;

        public NewDatabaseSourceViewModel(IEventAggregator eventPublisher, IManageDatabaseSourceViewModel vm, IPopupController popupController)
            : base(eventPublisher)
        {
            ViewModel = vm;
        ...
        {
            var view = new ManageDatabaseSourceControl();
            return view;
        }
        ...
        {
            var loadedView = view as ManageDatabaseSourceControl;
            if (loadedView != null)
            {
        ...
        public IManageDatabaseSourceViewModel ViewModel
        {
            get
            {
                return _vm;
