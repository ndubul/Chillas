...
namespace Warewolf.Studio.ViewModels.Tests
{
   ...
   public class DeployViewModelTests
   {
       ...
       {
           //------------Setup for test--------------------------
           var deployViewModel = new SingleExplorerDeployViewModel(null, new Mock<IDeploySourceExplorerViewModel>().Object,new List<IExplorerTreeItem>(),new Mock<DeployStatsViewerViewModel>().Object,new Mock<IShellViewModel>().Object);
       ...
       {
           //------------Setup for test--------------------------
           var deployViewModel = new SingleExplorerDeployViewModel(new Mock<IDeployDestinationExplorerViewModel>().Object, null, new List<IExplorerTreeItem>(), new Mock<DeployStatsViewerViewModel>().Object,new Mock<IShellViewModel>().Object);
       ...
       {
           //------------Setup for test--------------------------
           var deployViewModel = new SingleExplorerDeployViewModel(new Mock<IDeployDestinationExplorerViewModel>().Object, new Mock<IDeploySourceExplorerViewModel>().Object, null, new Mock<DeployStatsViewerViewModel>().Object, new Mock<IShellViewModel>().Object);
       ...
       {
           //------------Setup for test--------------------------
           var deployViewModel = new SingleExplorerDeployViewModel(new Mock<IDeployDestinationExplorerViewModel>().Object, new Mock<IDeploySourceExplorerViewModel>().Object, new List<IExplorerTreeItem>(), null, new Mock<IShellViewModel>().Object);
           //------------Execute Test---------------------------
