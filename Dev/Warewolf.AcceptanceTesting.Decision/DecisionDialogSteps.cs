...
namespace Warewolf.AcceptanceTesting.Decision
{
    ...
    public class DecisionDialogSteps
    {
        ...
        {
            var sourceControl = ScenarioContext.Current.Get<DecisionDesigner>(Utils.ViewNameKey);
        ...
        [Given(@"is ""(.*)"" ""(.*)"" ""(.*)""")]
        public void GivenIs(string p0, string p1, string p2)
        {
            ScenarioContext.Current.Pending();
        }
        ...
        [Given(@"a decision variable ""(.*)"" value ""(.*)""")]
        public void GivenADecisionVariableValue(string p0, int p1)
        {
            ScenarioContext.Current.Pending();
        }
        ...
        public void GivenMatchTypeHasVisible(string p0)
        {
            ScenarioContext.Current.Pending();
        }
        ...
        {
            var viewModel = Utils.GetViewModel<DecisionDesignerViewModel>();
        ...
        public void ThenADecisionVariableValue(string p0, string p1)
        {
            ScenarioContext.Current.Pending();
        }
